...
namespace BookMotelsAPI.Controllers
{
    ...
    public class ReservesController : ApiController
    {
        ...
        /// <param name="month">Opcional: Filtrar por mÍs.</param>
        /// <returns>Um relatÛrio de faturamento.</returns>
        /// <response code="200">Retorna o relatÛrio de faturamento.</response>
        /// <response code="401">Se o usu·rio n„o estiver autenticado.</response>
        /// <response code="403">Se o usu·rio autenticado n„o for um Admin.</response>
        ...
        /// </summary>
        /// <param name="reserveDto">Os detalhes de criaÁ„o da reserva.</param>
        /// <returns>A reserva rec√©m-criada.</returns>
        /// <response code="201">Retorna a reserva rec√©m-criada.</response>
        /// <response code="400">Se os detalhes de criaÁ„o da reserva forem inv√°lidos.</response>
        /// <response code="401">Se o usu·rio n„o estiver autenticado.</response>
        /// <response code="404">Se a su√≠te ou motel associado √† reserva n„o for encontrado.</response>
        ...
        /// <param name="reserveDto">Os detalhes de atualiza√ß√£o da reserva.</param>
        /// <returns>Nenhum conte√∫do.</returns>
        /// <response code="204">Se a reserva foi atualizada com sucesso.</response>
        /// <response code="400">Se os detalhes de atualiza√ß√£o da reserva forem inv√°lidos.</response>
        /// <response code="401">Se o usu·rio n„o estiver autenticado.</response>
        /// <response code="404">Se nenhuma reserva com o ID fornecido for encontrada.</response>
        /// <response code="409">Se houver um conflito com uma reserva existente.</response>
        [HttpPut("{id}")]
        ...
        /// Exclui uma reserva.
        /// </summary>
        /// <param name="id">O ID da reserva a ser exclu√≠da.</param>
        /// <returns>Nenhum conte√∫do.</returns>
        /// <response code="204">Se a reserva foi exclu√≠da com sucesso.</response>
        /// <response code="401">Se o usu·rio n„o estiver autenticado.</response>
        /// <response code="404">Se nenhuma reserva com o ID fornecido for encontrada.</response>
        [HttpDelete("{id}")]
